...
echo "For example, mine will be \"Fabricio Santos Guimarães\""
read git_config_user_name
git config --global user.name "$git_config_user_name"
clear 

echo "What email do you want to use in GIT user.email?"
echo "For example, mine will be \"fabricioashua@gmail.com\""
...
[ $ ( id -u )  ! =  " 0 " ] &&  exec sudo " $ 0 "  " $ @ "
echo -e " \ e [94mInstalando o Jetbrains Toolbox \ e [39m "
eco  " "

função  getLatestUrl () {
USER_AGENT = ( ' Agente do usuário: Mozilla / 5.0 (X11; Linux x86_64) AppleWebKit / 537.36 (KHTML, como Gecko) Chrome / 59.0.3071.115 Safari / 537.36 ' )

URL = $ ( curl ' https://data.services.jetbrains.com//products/releases?code=TBA&latest=true&type=release ' -H ' Origem: https://www.jetbrains.com ' -H ' Aceitar -Codificação: gzip, deflate, br ' -H ' Idioma de aceitação: en-US, en; q = 0.8 ' -H " $ {USER_AGENT [@]} " -H ' Accept: application / json, text / javascript, * / *; q = 0,01 ' -H ' Referer: https://www.jetbrains.com/toolbox/download/ ' -H ' Conexão: manter ativo '-H 'DNT: 1 '- compactado | grep -Po ' "linux":. *? [^ \\] ", '  | awk -F ' : '  ' {print $ 3,": "$ 4} ' | sed ' s / [",] // g ' )
eco  $ URL
}
getLatestUrl

ARQUIVO = $ ( nome da base $ {URL} )
DEST = $ PWD / $ ARQUIVO

eco  " "
echo -e " \ e [94mBaixando arquivos da caixa de ferramentas \ e [39m "
eco  " "
wget -cO   $ {DEST}  $ {URL} --read-timeout = 5 --tries = 0
eco  " "
echo -e " \ e [32mBaixar concluído! \ e [39m "
eco  " "
DIR = " / opt / jetbrains-toolbox "
eco  " "
echo   -e " \ e [94mInstalando em $ DIR \ e [39m "
eco  " "
se mkdir $ {DIR} ;  então
